<form class="f-row form-style products-categories-edit" method="post" autocomplete="off">
    ...
    <div class="input-group-s col-md-down-1 col-md-up-2">
        ...
        <input type="text" name="name" value="{ ProductWarehouse->Name }" min="3" max="40"  data-pattern="^[A-z \u0600-\u06FF]{3,40}$" >
    </div>

    <div class="input-group-s col-md-down-1 col-md-up-2">
        <label >{ label_description }</label>
        <input type="text" name="description" value="{ ProductWarehouse->Name }" min="0" max="5000"  data-pattern="^[\w\(\):?!\- \u0600-\u06FF]{0,5000}$" >
    </div>
