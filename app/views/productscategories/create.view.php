<form class="f-row form-style products-categories-create" method="post" autocomplete="off">
    <span class="form-title bn">{ text_title_form }</span>
    <div class="input-group-s col-md-down-1 col-md-up-2">
        <label >{ label_name }</label>
        <input type="text" name="name" value="@post (name)" min="3" max="40"  data-pattern="^[A-z \u0600-\u06FF]{3,40}$" >
    </div>
