...
class ProductsModel extends AbsModel
{
    ...
    public $ProductId, $kod, $Title, $Tax, $UnitId , $MadeCountry, $AddedDate, $CategoryId, $SubCategoryId, $WarehouseId, /*$Quantity,*/ $QuantityReservation, /*$NotificationQuantity,*/ $Barcode, $SellPrice, $BuyPrice, $PromoPrice, $AddedName, $ModifyDate, $ModifyName, $Comment, $WwwId, $TypeId, $StatusId, $YearId, $RimsId, $FrameId, $ReservationId, $WwwUrl, $Allegro;
